    ...
    <div class="container">
        <?php if (mysqli_num_rows($result) > 0) { 
            ...
            <div class="jumbotron mt-3">
                ...
                <p class="lead">Perolehan Suara : <?php echo $row['perolehan'] ?></p>
                <a class="btn btn-lg btn-primary" href="tambah.php?id=<?php echo $row['id'] ?>" role="button">Tambah Suara &raquo;</a>
            </div>`
            <?php
        }
      }
